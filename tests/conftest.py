...
def user_three_winding_transformer_specs() -> UserThreeWindingTransformerSpecifications:
    ...
    return UserThreeWindingTransformerSpecifications(
        no_load_loss=20,
        lv_winding=WindingSpecifications(nom_load=1000, nom_power=30),
        mv_winding=WindingSpecifications(nom_load=1000, nom_power=100),
        hv_winding=WindingSpecifications(nom_load=1000, nom_power=100),
        load_loss_hv_lv=100,
        load_loss_hv_mv=100,
        load_loss_mv_lv=100,
    )
