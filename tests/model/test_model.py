...
from transformer_thermal_model.transformer import PowerTransformer, ThreePhaseTransformer
...
def test_threephase_transformer_initialization(user_three_phase_transformer_specs, three_phase_input_profile):
